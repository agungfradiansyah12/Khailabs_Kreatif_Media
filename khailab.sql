...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Des 2022 pada 05.14
...
(5, 'Morning Glory', 'Melaporkan hasil sprint selama 2 minggu ke Investor atau publisher', '2022-12-09', 1),
...
(11, 'Mentoring Wali', 'Mentoring bersama mentor wali setiap satu bulan sekali, untuk melaporkan kendala kendala salama pembuatan game\"', '2022-12-30', 1);
...
INSERT INTO `tb_berita` (`id_berita`, `judul_berita`, `konten_berita`, `tanggal`, `gambar`, `id_user`) VALUES
(5, 'kasj', 'jhbnjnj ', '2022-10-13', 'service-details-1.jpg', 0),
(7, 'RPL 2', '', '2022-10-26', 'service-details-2.jpg', 0),
(8, 'abin', 'muhammad bintang pratama', '2022-10-12', 'a.jpg', 0),
(9, 'hghgh', 'jnj', '2022-10-05', 'service-details-4.jpg', 0);
...
CREATE TABLE `tb_pegawai` (
  ...
  `instagram_pegawai` text NOT NULL,
  `facebook_pegawai` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tb_pegawai` (`id_pegawai`, `nama_pegawai`, `telp`, `alamat_pegawai`, `foto_pegawai`, `tanggal_lahir`, `jabatan_pegawai`, `email_pegawai`, `tentang_jabatan`, `instagram_pegawai`, `facebook_pegawai`) VALUES
(2, 'Gulpi Qorik Oktagalu Pratamasunu', 'https://wa.me/6281255200040', 'Paiton, Probolinggo, Indonesia', '1.png', '2022-12-08', 'Team Lead & Game Designer', 'gulpi.qorik@gmail.com', 'Seseorang yang  memegang saham atau pemilik perusahaan untuk memimpin dan mengelola perusahaan.', '', ''),
...
(9, 'kuku', 'kuku@gmail.com', 'jajaja', '2022-11-08'),
(10, 'aaaa', 'agungfradiansyah2@gmail.com', 'as', '2022-12-04');
...
--
ALTER TABLE `tb_agenda`
  MODIFY `id_agenda` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tb_pesan`
  MODIFY `id_pesan` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
